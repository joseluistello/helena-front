...
<h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
  ...
  <span className="relative whitespace-nowrap text-blue-600">
    ...
    <span className="relative">apoyo </span>
  </span>
...
Estaremos contigo en todo momento, incluso en los momentos más difíciles de la vida. Empieza hoy y obtén el acompañamiento que necesitas, cuando más lo necesitas.
  </p>
